...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Design Mart: Add Products</title>
  </head>
  <body>
      ...
      <div class="row second-row">
        <div class="col-md-3 dash_nav">
          <ul>
            ...
            <li class="dash_nav_item"><a href="add_product_1.php" class="dash_nav_link active">Add Product</a></li>
        ...
        <div class="col-md-9 text-left my-4">
          ...
          if (isset($_REQUEST['add_status'])){
            ...
            $add_status = $_REQUEST['add_status'];
            ...
            if ($add_status == 'pass') {
              ...
              <div class="alert alert-success alert-dismissible text-center login_failed_message">
                ...
                <p class="lead">Product successfully added</p>
              </div>
              ...
              <div class="alert alert-danger alert-dismissible text-center login_failed_message">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
                <p class="p-0 m-2 lead">Failed to add product</p>
                <p class="p-0 mb-3" style="font-size: 17px;">Please follow provided guidelines to upload image</p>
              </div>
          ...
          <!-- row div starts here -->
          <div class="row">
            <form class="form-control add_form" action="add_product_2.php" method="post" enctype="multipart/form-data">

              <div class="form-row">
                <div class="form-group col-md-12">
                  <label for="name" class="label mx-1 text-light">Product Name</label>
                  <input type="text" class="form-control" name="pro_name" id="pro_name" maxlength="18" required>
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="number" class="form-control col-md-8" name="pro_price" id="pro_price" value="" required>
                </div>

                <div class="form-group col-md-6">
                  <label for="name" class="label mx-1 text-light">Product Material</label>
                  <input type="text" class="form-control" name="pro_material" id="pro_material" value="" required>
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control col-md-6" id="pro_category" name="pro_category"  required>
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="input-group mx-1 mb-2 ">
                    ...
                    <input type="file" class="form-control" name="pro_img" id="pro_img" required>
                  </div>
              ...
              <div class="form-row my-3">
                <input type="submit" name="submit" value="Add New Product" class="btn mx-1" id="defaultbtn">
              </div>
