      ...
      <div class="row second-row">
        ...
        <div class="col-md-9 text-left my-4">
          ...
          <div class="row my-4">
            ...
            <form class="form w-100" action="delete_product_1.php" method="post" enctype="multipart/form-data">
           ...
           <div class="row col-lg-12 col-md-12">
             <?php
              ...
              if (isset($_REQUEST['delete_status'])) {
                if ($_REQUEST['delete_status'] == 'pass') {
                  ?>
                  ...
                  <div class="alert alert-success alert-dismissible text-center login_failed_message col-lg-12">
                    ...
                    <p class="lead">Product successfully deleted</p>
                  </div>
                  <?php
                }
              }
                        ...
                        if(mysqli_num_rows($rsSearchID)>0){
                          ...
                          while ($rowSearchID = mysqli_fetch_assoc($rsSearchID)){
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                <a class="btn btn-sm w-75 btn-secondary" id="defaultbtn" href="delete_product_2.php?pro_id=<?php echo $rowSearchID['pro_id']; ?>">Delete</a>
                              </td>
                            </tr>
                            <?php
                          }
                        ...
                        while ($rowSearchName = mysqli_fetch_assoc($rsSearchName)){
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              ...
                              href="delete_product_2.php?pro_id=<?php echo $rowSearchName['pro_id']; ?>">Delete</a>
                            </td>
                          </tr>
                          <?php
                        }
                    ...
                    if(mysqli_num_rows($rs2)>0){
                     while ($row2 = mysqli_fetch_assoc($rs2)){
                       ...
                       <tr>
                         ...
                         <td class="text-center">
                           <a class="btn btn-sm w-75 btn-secondary" id="defaultbtn" href="delete_product_2.php?pro_id=<?php echo $row2['pro_id']; ?>">Delete</a>
                         </td>
                       </tr>
                       <?php
                     }
