	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 col-xs-12 my-5" id="loginform" >
				...
				<h1 class="text-dark pt-4 text-center">Login</h1>
				...
				<form class="" action="login_2.php" onsubmit="return validateForm()" method="post">
					...
					<div class="form-group">
						...
						<input type="password" class="form-control" id="access_code" name="access_code" value="">
					</div>

					<div class="form-group">
						<p><input type="checkbox" class="checkbox" name="" value=""> Remember me</p>
					</div>

					<div class="form-group text-center">
						<input type="submit" value="Login" class="btn btn-outline-secondary w-50" id="defaultbtn">
					</div>
